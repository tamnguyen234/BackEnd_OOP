...
/**
 * Interface định nghĩa các dịch vụ (Service) liên quan đến Quản lý Người dùng
 * (User Management).
 * * Chịu trách nhiệm thực hiện logic nghiệp vụ như truy xuất thông tin, cập
 * nhật hồ sơ,
...
public interface UserService {
     ...
     * * ID này được trích xuất từ JWT Token trong Security Context (dựa trên luồng
     * xác thực).
     * 
     ...
     * * Phương thức này chuyển đổi Entity sang DTO (UserResponse) trước khi trả về
     * Controller.
     * 
     ...
     * * Khi xóa, các dữ liệu liên quan (Expense, Budget) cũng sẽ bị xóa do cấu hình
     ...
     * * Phương thức này sử dụng DTO UserResponse (có thể không chính xác nếu
     * UserResponse không phải là DTO request).
     * * LƯU Ý: Có vẻ đây là phương thức trùng lặp/thừa và nên dùng phương thức bên
     * dưới.
     * 
     ...
     * @return Optional chứa đối tượng User nếu tìm thấy, ngược lại là
     *         Optional.empty().
     */
